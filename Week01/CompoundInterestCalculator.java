...
/*
 * Compound Interest Calculator by Sean O'Dowd
 * 
 ...
 * this formula with 2 decimal places: A = P(1 + r/n)^nt
 * 
 ...
 *   r = R/100
 *   n = number of compounding periods per unit of time, 12 months
...
public class CompoundInterestCalculator {
	...
	public static void main(String[] args) {
		...
		double r = rate/100;
		double amount = principal * Math.pow(1 + r / 12.0, 12 * time);
		System.out.format("The total amount accrued, principal"
				+ " plus interest, with compound interest \non a principal of "
				+ "$%,.2f at a rate of %.2f%% per year \ncompounded 12 times "
				+ "per year over %f years is $%,.2f" 
